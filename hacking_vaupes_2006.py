...
# Vector de Amazonas
amazonas = ["001", "004", "010", "013", "017", "022"]
munpos =  ["MITU", "CARURU", "MORICHAL (PAPUNAGUA)", "BUENOS AIRES (PACOA)", "TARAIRA", "YAVARATE"]
DANE = ["97001", "97161", "97777", "97511", "97666", "97889"]

campos = [6, 8, 10, 12, 14, 20, 22, 24, 26, 28, 30, 32]

# Creamos archivo plano con info de las elecciones de Amazonas
f = open('Vaupes_2006.txt', 'w')
f.write
for munpo in range(len(amazonas)):
	# Consolido el Linl
	url = "http://web.registraduria.gov.co/eleccionesPresidente/votacionPartidosMunicipios.jsp?cod_corpo=PR&cod_visibilidad=2&num_com=99&cod_depto=68&cod_mpio="+amazonas[munpo]
