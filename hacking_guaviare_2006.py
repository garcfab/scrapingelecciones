...
# Vector de Amazonas
amazonas = ["001", "003", "007", "012"]
munpos =  ["SAN JOSE DEL GUAVIARE", "CALAMAR", "EL RETORNO", "MIRAFLORES"]
DANE = ["95001", "95015", "95025", "95200"]

campos = [6, 8, 10, 12, 14, 20, 22, 24, 26, 28, 30, 32]

# Creamos archivo plano con info de las elecciones de Amazonas
f = open('Guaviare_2006.txt', 'w')
f.write
for munpo in range(len(amazonas)):
	# Consolido el Linl
	url = "http://web.registraduria.gov.co/eleccionesPresidente/votacionPartidosMunicipios.jsp?cod_corpo=PR&cod_visibilidad=2&num_com=99&cod_depto=54&cod_mpio="+amazonas[munpo]
