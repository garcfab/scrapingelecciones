...
# Vector de Amazonas
amazonas = ["001", "008", "013", "021", "025", "029", "038", "046", "054", "062", "070", "078", "086", "094"]
munpos =  ["PEREIRA", "APIA", "BALBOA", "BELEN DE UMBRIA", "DOSQUEBRADAS", "GUATICA", "LA CELIA", "LA VIRGINIA", "MARSELLA", "MISTRATO", "PUEBLO RICO", "QUINCHIA", "SANTA ROSA DE CABAL", "SANTUARIO"]
DANE = ["66001", "66045", "66045", "66088", "66170", "66318", "66383", "66400", "66440", "66456", "66572", "66594", "66682", "66687"]

campos = [6, 8, 10, 12, 14, 20, 22, 24, 26, 28, 30, 32]

# Creamos archivo plano con info de las elecciones de Amazonas
f = open('Risaralda_2006.txt', 'w')
f.write
for munpo in range(len(amazonas)):
	# Consolido el Linl
	url = "http://web.registraduria.gov.co/eleccionesPresidente/votacionPartidosMunicipios.jsp?cod_corpo=PR&cod_visibilidad=2&num_com=99&cod_depto=24&cod_mpio="+amazonas[munpo]
